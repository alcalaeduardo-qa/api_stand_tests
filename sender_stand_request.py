...
#Función post_products_kits() en el archivo sender_stand_request.py.
#Esta función recibe la ID de los productos (products_ids) como entrada y devuelve los kits como respuesta
